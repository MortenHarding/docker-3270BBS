...
echo "wget -O /home/tsu https://github.com/moshix/3270BBS/releases/latest/download/${ASSETNAME}"
wget  -O /home/tsu "https://github.com/moshix/3270BBS/releases/latest/download/${ASSETNAME}"
