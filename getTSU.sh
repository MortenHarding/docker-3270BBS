...
echo "wget -O /opt/3270bbs/tsu https://github.com/moshix/3270BBS/releases/latest/download/${LATESTASSET}"
wget -q -O /opt/3270bbs/tsu "https://github.com/moshix/3270BBS/releases/latest/download/${LATESTASSET}"
